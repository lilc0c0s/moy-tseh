...
⚠️ **Это витринный (публичный) репозиторий.** Кодовая база продукта закрыта и находится в промышленной эксплуатации у клиентов. Здесь — архитектура, инженерные решения и результаты пилота: [docs/architecture.md](docs/architecture.md) · [docs/ai-pipeline.md](docs/ai-pipeline.md) · [docs/security-multitenancy.md](docs/security-multitenancy.md) · [docs/results.md](docs/results.md) · [examples/dialog-examples.md](examples/dialog-examples.md)
...
- Статус: промышленная эксплуатация на пилотных предприятиях; грант ФСИ направляется на доработку продукта до тиражируемого SaaS и вывод на рынок
